...
void setup() {
    ...
    // Initialize SPI early - required before MCP_CAN constructor runs
    SPI.begin();
...
//        Can232::init(CAN_125KBPS);  // rate = 125, clock = LW232_DEFAULT_CLOCK_FREQ
    ...
    // Attach interrupt AFTER Can232 instance is created to prevent crash if interrupt fires early
